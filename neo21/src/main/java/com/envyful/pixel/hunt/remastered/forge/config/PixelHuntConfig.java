...
public class PixelHuntConfig extends AbstractYamlConfig {
        ...
        this.hunts.addAll(YamlConfigFactory.getInstances(HuntConfig.class, "config/EnvyHunt/hunts/",
                DefaultConfig.onlyNew("defaults/basic.yml", HuntConfig.builder("example")
                        ...
                        .rewards(ConfigRewardPool.builder(ConfigReward.builder()
                                        .commands("broadcast Shiny hunt was completed by %player%")
                                        .build())
                                .maxRolls(1)
                                .minRolls(1)
                                .rewards(new ConfigRandomWeightedSet<>(
                                        new ConfigRandomWeightedSet.WeightedObject<>(10, ConfigReward.builder()
                                                .commands("broadcast Shiny hunt was completed by %player%")
                                                .build()),
                                        new ConfigRandomWeightedSet.WeightedObject<>(1, ConfigReward.builder()
                                                .commands("broadcast Shiny hunt was completed by %player%")
                                                .build())
                                ))
                                .build())
    ...
    public static class HuntRewardUI {
        ...
        private ConfigInterface guiSettings = ConfigInterface.defaultInterface("Rewards", 3);
